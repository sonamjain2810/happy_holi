...
class AppTheme {
  ...
  static  Color _lightPrimaryColor = Colors.yellow[100];
  static  Color _lightPrimaryVariantColor = Colors.yellow[700];
  static const Color _lightSecondaryColor = Colors.grey;
  static  Color _lightOnPrimaryColor = Colors.pink[400];
  static  Color _lightPrimaryIconThemeColor = Colors.deepPurple;
  ...
  static const Color _lightAppBarTextColor = Colors.deepPurple;
